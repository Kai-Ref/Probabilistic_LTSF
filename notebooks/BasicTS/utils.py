...
def init(model, dataset, path, no_logging=False):
    if no_logging:
    ...
    save_dir = f'/home/kreffert/Probabilistic_LTSF/BasicTS/checkpoints/{distribution_type}_{model}/{data_name}_{num_epochs}_{seq_len}_{pred_len}/{path}'
