...
# python ~/Probabilistic_LTSF/BasicTS/experiments/hp_tuning.py -c baselines/PatchTST/ETTh1_prob.py -s /home/kreffert/Probabilistic_LTSF/BasicTS/hp_tuning/PatchTST.yaml --gpus '0'
