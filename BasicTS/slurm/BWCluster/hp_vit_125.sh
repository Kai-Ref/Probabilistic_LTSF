...
# export MASTER_PORT=29600    # The port for communication (can be any available port)

# Launch the training with two G<PUs
# torchrun --nproc_per_node=2 --nnodes=1 --node_rank=0 --master_addr="localhost" --master_port=29600 ~/Interpretable-Deep-Fake-Detection/training/hp_tuning.py --detector_path ~/Interpretable-Deep-Fake-Detection/training/config/detector/vit_bcos.yaml --ddp --sweep_id om1v67lc
python ~/Interpretable-Deep-Fake-Detection/training/hp_tuning.py --detector_path ~/Interpretable-Deep-Fake-Detection/training/config/detector/vit_bcos.yaml --sweep_id om1v67lc