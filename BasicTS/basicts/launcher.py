...
def training_func(cfg: Dict, wandb_run=None) -> Dict:
    """
...
def sweep_agent_function(cfg: Dict) -> Dict:
    """
    ...
    # print(cfg)
    # print("-------------------")
    # wandb_config = fill_dependencies(wandb_config, model_name='PatchTST', data_name='ETTh1')
    # print(wandb_config)
