...
NORM_EACH_CHANNEL = False  # Overwritten by new value
...
MODEL_PARAM = {
    ...
    "distribution_type": "i_quantile",  # Overwritten by new value
...
CFG.TRAIN.OPTIM.PARAM = {
    "lr": 0.009139663805893684,  # Overwritten
    "weight_decay": 0.00004232142938425769,  # Overwritten
}
CFG.TRAIN.LR_SCHEDULER = EasyDict()
CFG.TRAIN.LR_SCHEDULER.TYPE = "MultiStepLR"
CFG.TRAIN.LR_SCHEDULER.PARAM = {
    "milestones": [5, 25],
    "gamma": 0.1706296661763049,  # Overwritten
}
