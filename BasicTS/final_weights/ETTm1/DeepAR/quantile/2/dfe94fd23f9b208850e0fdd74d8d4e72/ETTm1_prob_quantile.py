...
MODEL_PARAM = {
    ...
    'embedding_size': 32,  # updated
    'hidden_size': 128,  # updated from 128 to 16
    'num_layers': 2,  # updated from 4 to 8
    'use_ts_id': True,  # updated
    'id_feat_size': 32,  # updated from 32 to 16
    'num_nodes': 7,
...
NUM_EPOCHS = 100  # unchanged (already 100)
...
CFG.DATASET.TYPE = OneStepForecastingDataset # TimeSeriesForecastingDataset
...
CFG.SCALER = EasyDict()
CFG.SCALER.TYPE = ZScoreScaler  # updated (unchanged, was already ZScoreScaler)
...
CFG.TRAIN.EARLY_STOPPING_PATIENCE = 5  # updated (unchanged)
...
CFG.TRAIN.OPTIM.TYPE = "Adam"  # updated (unchanged)
CFG.TRAIN.OPTIM.PARAM = {
    'lr': 0.019779656852350763,  # updated
    "weight_decay": 0.0000938118267847646,  # updated
}
CFG.TRAIN.LR_SCHEDULER = EasyDict()
CFG.TRAIN.LR_SCHEDULER.TYPE = "MultiStepLR"  # updated (unchanged)
CFG.TRAIN.LR_SCHEDULER.PARAM = {
    "milestones": [5, 25],
    "gamma": 0.010131206545568571  # updated
}
CFG.TRAIN.CLIP_GRAD_PARAM = {
    'max_norm': 5.0
}
CFG.TRAIN.DATA = EasyDict()
CFG.TRAIN.DATA.BATCH_SIZE = 64  # updated from 32 to 64
