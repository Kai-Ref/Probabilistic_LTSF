...
MODEL_PARAM = {
    ...
    "d_model": 64,
    "d_ff": 16,
    "dropout": 0.07012847807908715,
    "fc_dropout": 0.291308172472538,
    "head_dropout": 0.08151345238514762,
    "patch_len": 64,
    "stride": 64,
    "individual": 1,
    "padding_patch": "None",
    ...
    "act": "gelu",
    "attn_dropout": 0.2741374781833717,
    "learn_pe": True,
    "norm": "LayerNorm",
    "pe": "normal",
    "pre_norm": False
...
CFG.TRAIN.OPTIM.PARAM = {
    "lr": 0.004746239029181962,
    "weight_decay": 0.00034512810220888116,
}
CFG.TRAIN.LR_SCHEDULER = EasyDict()
CFG.TRAIN.LR_SCHEDULER.TYPE = "MultiStepLR"
CFG.TRAIN.LR_SCHEDULER.PARAM = {
    "milestones": [1, 25],
    "gamma": 0.14024700578887225
}
