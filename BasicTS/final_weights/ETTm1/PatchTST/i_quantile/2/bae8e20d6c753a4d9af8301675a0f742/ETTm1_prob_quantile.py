...
MODEL_PARAM = {
    ...
    "d_model": 16,
    "d_ff": 16,
    "dropout": 0.06423388698928945,
    "fc_dropout": 0.33338073269029167,
    "head_dropout": 0.038230261714027054,
    "patch_len": 8,
    "stride": 4,
    "individual": 0,
    "padding_patch": "end",
    ...
    "attn_dropout": 0.3129294138882104,
    "act": "gelu",
    "norm": "BatchNorm",
    "learn_pe": True,
    "pre_norm": False,
    ...
    "prob_args": {
        ...
        "decoding": "hadamard",
        "fixed_qe": 384, # d_model * ((96 -patch_len)/stride + 1)+1
        "num_layers": 7,
...
CFG.TRAIN.OPTIM.PARAM = {
    "lr": 0.0075447813818555086,
    "weight_decay": 0.00003113720180344312,
}
